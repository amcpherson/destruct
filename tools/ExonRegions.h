...
{
public:
	void Read(const string& exonRegionsFilename);
	...
	void GetRegionGenes(const string& chromosome, const Region& region, set<string>& genes) const;
	void GetRegionTranscripts(const string& chromosome, const Region& region, set<string>& transcripts) const;
